...
/**
 * https://www.javazhiyin.com/62893.html
...
public class BuyTicketThread extends Thread {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        BuyTicketThread ticketThreadA = new BuyTicketThread("售票点A");
        BuyTicketThread ticketThreadB = new BuyTicketThread("售票点B");
        BuyTicketThread ticketThreadC = new BuyTicketThread("售票点C");
